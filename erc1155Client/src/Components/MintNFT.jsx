...
const MintNFT = () => {
    ...
    const ListNFT = async () => {
        ...
        const Metadata = {
            name: "Aditya",
            description: "Aditya Suryawanshi",
            image: 'https://media.npr.org/assets/img/2014/01/02/140102123909_1_wide-da99ab742e0a327bf840d4b8e01b864b019482ca-s1100-c50.jpg'
            ,
        }
        ...
        const contractnew = await sdkt.getContract("0xDC5A319945E0c84e7A559DC2FbCC99fB7f88c43a");

        await contractnew.roles.grant("minter", Account);

        const signedPayload = await contractnew.erc1155.mintTo(Account, Metadata);
    }
                                ...
                                <div className="flip-card__inner">
                                    <div className="flip-card__front">
                                        ...
                                        <form className="flip-card__form" action="">
                                            ...
                                            <input className="flip-card__input" placeholder="Name" type="text" onChange={InputNameHandle} value={NFTName} />

                                            <input className="flip-card__input" placeholder="Description" type="text" onChange={InputDescHandle} value={NFTDescription} />

                                            <input className="flip-card__input" placeholder="Supply" type="number" onChange={InputSupplyHandle} value={SupplyNumber} />
                                    ...
                                    <div className="flip-card__back">
                                        <label className="custum-file-upload" htmlFor="file">
                                            ...
                                            <input type="file" id="file" onChange={HandleFile} value={Image} />
                                        </label>
