...
const MintNFT = () => {
    ...
    const ListNFT = async () => {
        ...
        const imageuploaded=document.getElementById('imageuploaded').innerHTML;
                                ...
                                <div className="flip-card__inner">
                                    <div className="flip-card__front">
                                        ...
                                        <form className="flip-card__form" action="">
                                            ...
                                            <input className="flip-card__input" type="text" onChange={InputNameHandle} />

                                            <input className="flip-card__input" type="text" onChange={InputDescHandle} />

                                            <input className="flip-card__input" type="number" onChange={InputSupplyHandle} />
